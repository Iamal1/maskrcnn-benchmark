...
from maskrcnn_benchmark.solver import make_optimizer_for_predictor
...
def train(cfg, local_rank, distributed):
    ...
    optimizer = make_optimizer_for_predictor(cfg, model)
    ...
    checkpointer = DetectronCheckpointer(
        cfg, model, optimizer, scheduler, output_dir, save_to_disk, only_model=True
    )
